...
public class UP2019 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_up2019);
        ImageView imageView = findViewById(R.id.image2019_17);
        ...
        RadioGroup rg76 = findViewById(R.id.rg76);
        RadioGroup rg77 = findViewById(R.id.rg77);
        RadioGroup rg78 = findViewById(R.id.rg78);
        RadioGroup rg79 = findViewById(R.id.rg79);
        RadioGroup rg80 = findViewById(R.id.rg80);
        RadioGroup rg81 = findViewById(R.id.rg81);
        RadioGroup rg82 = findViewById(R.id.rg82);
        RadioGroup rg83 = findViewById(R.id.rg83);
        RadioGroup rg84 = findViewById(R.id.rg84);
        RadioGroup rg85 = findViewById(R.id.rg85);
        RadioGroup rg86 = findViewById(R.id.rg86);
        RadioGroup rg87 = findViewById(R.id.rg87);
        RadioGroup rg88 = findViewById(R.id.rg88);
        RadioGroup rg89 = findViewById(R.id.rg89);
        RadioGroup rg90 = findViewById(R.id.rg90);
        RadioGroup rg91 = findViewById(R.id.rg91);
        RadioGroup rg92 = findViewById(R.id.rg92);
        RadioGroup rg93 = findViewById(R.id.rg93);
        RadioGroup rg94 = findViewById(R.id.rg94);
        RadioGroup rg95 = findViewById(R.id.rg95);
        RadioGroup rg96 = findViewById(R.id.rg96);
        RadioGroup rg97 = findViewById(R.id.rg97);
        RadioGroup rg98 = findViewById(R.id.rg98);
        RadioGroup rg99 = findViewById(R.id.rg99);
        RadioGroup rg100 = findViewById(R.id.rg100);
        rg1.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q2 = findViewById(R.id.q1a);
                RadioButton q1 = findViewById(R.id.q1b);
        ...
        rg2.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q2 = findViewById(R.id.q2a);
                RadioButton q1 = findViewById(R.id.q2b);
        ...
        rg5.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q2 = findViewById(R.id.q5a);
                RadioButton q1 = findViewById(R.id.q5b);
                RadioButton q3 = findViewById(R.id.q5c);
                RadioButton q4 = findViewById(R.id.q5d);
                switch (checkedId) {
                    case R.id.q5b:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg7.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q4 = findViewById(R.id.q7a);
                RadioButton q2 = findViewById(R.id.q7b);
                RadioButton q3 = findViewById(R.id.q7c);
                RadioButton q1 = findViewById(R.id.q7d);
                switch (checkedId) {
                    case R.id.q7d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg9.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q4 = findViewById(R.id.q9a);
                RadioButton q2 = findViewById(R.id.q9b);
                RadioButton q3 = findViewById(R.id.q9c);
                RadioButton q1 = findViewById(R.id.q9d);
                switch (checkedId) {
                    case R.id.q9d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg10.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q10a);
                RadioButton q2 = findViewById(R.id.q10b);
                RadioButton q3 = findViewById(R.id.q10c);
        ...
        rg12.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                RadioButton q4 = findViewById(R.id.q12c);
                RadioButton q1 = findViewById(R.id.q12d);
                switch (checkedId) {
                    case R.id.q12d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg14.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                RadioButton q3 = findViewById(R.id.q14b);
                RadioButton q1 = findViewById(R.id.q14c);
        ...
        rg15.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                RadioButton q1 = findViewById(R.id.q15b);
                RadioButton q3 = findViewById(R.id.q15c);
                RadioButton q4 = findViewById(R.id.q15d);
                switch (checkedId) {
                    case R.id.q15b:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg17.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q17a);
                RadioButton q2 = findViewById(R.id.q17b);
                RadioButton q3 = findViewById(R.id.q17c);
        ...
        rg18.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q3 = findViewById(R.id.q18a);
                RadioButton q2 = findViewById(R.id.q18b);
                RadioButton q4 = findViewById(R.id.q18c);
                RadioButton q1 = findViewById(R.id.q18d);
                switch (checkedId) {
                    case R.id.q18d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg19.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q4 = findViewById(R.id.q19a);
                RadioButton q2 = findViewById(R.id.q19b);
                RadioButton q1 = findViewById(R.id.q19c);
                RadioButton q3 = findViewById(R.id.q19d);
                switch (checkedId) {
                    case R.id.q19c:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg21.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q21a);
                RadioButton q2 = findViewById(R.id.q21b);
                RadioButton q3 = findViewById(R.id.q21c);
        ...
        rg22.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                RadioButton q2 = findViewById(R.id.q22b);
                RadioButton q4 = findViewById(R.id.q22c);
                RadioButton q1 = findViewById(R.id.q22d);
                switch (checkedId) {
                    case R.id.q22d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg23.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q23a);
                RadioButton q2 = findViewById(R.id.q23b);
                RadioButton q3 = findViewById(R.id.q23c);
                RadioButton q4 = findViewById(R.id.q23d);
                switch (checkedId) {
                    case R.id.q23a:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg25.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q4 = findViewById(R.id.q25a);
                RadioButton q2 = findViewById(R.id.q25b);
                RadioButton q3 = findViewById(R.id.q25c);
                RadioButton q1 = findViewById(R.id.q25d);
                switch (checkedId) {
                    case R.id.q25d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg26.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q2 = findViewById(R.id.q26a);
                RadioButton q4 = findViewById(R.id.q26b);
                RadioButton q3 = findViewById(R.id.q26c);
                RadioButton q1 = findViewById(R.id.q26d);
                switch (checkedId) {
                    case R.id.q26d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg27.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q3 = findViewById(R.id.q27a);
                RadioButton q1 = findViewById(R.id.q27b);
                RadioButton q2 = findViewById(R.id.q27c);
        ...
        rg28.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q4 = findViewById(R.id.q28a);
                RadioButton q2 = findViewById(R.id.q28b);
                RadioButton q3 = findViewById(R.id.q28c);
                RadioButton q1 = findViewById(R.id.q28d);
                switch (checkedId) {
                    case R.id.q28d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg29.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q4 = findViewById(R.id.q29a);
                RadioButton q2 = findViewById(R.id.q29b);
                RadioButton q3 = findViewById(R.id.q29c);
                RadioButton q1 = findViewById(R.id.q29d);
                switch (checkedId) {
                    case R.id.q29d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg30.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                RadioButton q2 = findViewById(R.id.q30b);
                RadioButton q1 = findViewById(R.id.q30c);
                RadioButton q3 = findViewById(R.id.q30d);
                switch (checkedId) {
                    case R.id.q30c:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg31.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                RadioButton q1 = findViewById(R.id.q31b);
                RadioButton q3 = findViewById(R.id.q31c);
        ...
        rg32.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                RadioButton q2 = findViewById(R.id.q32b);
                RadioButton q3 = findViewById(R.id.q32c);
                RadioButton q1 = findViewById(R.id.q32d);
                switch (checkedId) {
                    case R.id.q32d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg34.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q34a);
                RadioButton q2 = findViewById(R.id.q34b);
                RadioButton q3 = findViewById(R.id.q34c);
        ...
        rg35.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q35a);
                RadioButton q2 = findViewById(R.id.q35b);
                RadioButton q3 = findViewById(R.id.q35c);
                RadioButton q4 = findViewById(R.id.q35d);
                switch (checkedId) {
                    case R.id.q35a:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg37.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q37a);
                RadioButton q2 = findViewById(R.id.q37b);
                RadioButton q3 = findViewById(R.id.q37c);
                RadioButton q4 = findViewById(R.id.q37d);
                switch (checkedId) {
                    case R.id.q37a:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg38.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q3 = findViewById(R.id.q38a);
                RadioButton q2 = findViewById(R.id.q38b);
                RadioButton q4 = findViewById(R.id.q38c);
                RadioButton q1 = findViewById(R.id.q38d);
                switch (checkedId) {
                    case R.id.q38d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg39.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                RadioButton q3 = findViewById(R.id.q39c);
                RadioButton q1 = findViewById(R.id.q39d);
                switch (checkedId) {
                    case R.id.q39d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg41.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q41a);
                RadioButton q2 = findViewById(R.id.q41b);
        ...
        rg42.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q4 = findViewById(R.id.q42a);
                RadioButton q2 = findViewById(R.id.q42b);
                RadioButton q3 = findViewById(R.id.q42c);
                RadioButton q1 = findViewById(R.id.q42d);
                switch (checkedId) {
                    case R.id.q42d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg43.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                RadioButton q2 = findViewById(R.id.q43b);
                RadioButton q1 = findViewById(R.id.q43c);
                RadioButton q3 = findViewById(R.id.q43d);
                switch (checkedId) {
                    case R.id.q43c:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg44.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q4 = findViewById(R.id.q44a);
                RadioButton q2 = findViewById(R.id.q44b);
                RadioButton q3 = findViewById(R.id.q44c);
                RadioButton q1 = findViewById(R.id.q44d);
                switch (checkedId) {
                    case R.id.q44d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg45.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q2 = findViewById(R.id.q45a);
                RadioButton q1 = findViewById(R.id.q45b);
                RadioButton q3 = findViewById(R.id.q45c);
                RadioButton q4 = findViewById(R.id.q45d);
                switch (checkedId) {
                    case R.id.q45b:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg46.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q2 = findViewById(R.id.q46a);
                RadioButton q1 = findViewById(R.id.q46b);
                RadioButton q3 = findViewById(R.id.q46c);
        ...
        rg47.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                RadioButton q4 = findViewById(R.id.q47b);
                RadioButton q3 = findViewById(R.id.q47c);
                RadioButton q1 = findViewById(R.id.q47d);
                switch (checkedId) {
                    case R.id.q47d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg48.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                RadioButton q2 = findViewById(R.id.q48b);
                RadioButton q3 = findViewById(R.id.q48c);
        ...
        rg49.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                RadioButton q4 = findViewById(R.id.q49b);
                RadioButton q3 = findViewById(R.id.q49c);
                RadioButton q1 = findViewById(R.id.q49d);
                switch (checkedId) {
                    case R.id.q49d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg51.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q3 = findViewById(R.id.q51a);
                RadioButton q2 = findViewById(R.id.q51b);
                RadioButton q1 = findViewById(R.id.q51c);
        ...
        rg52.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q3 = findViewById(R.id.q52a);
                RadioButton q2 = findViewById(R.id.q52b);
                RadioButton q1 = findViewById(R.id.q52c);
                RadioButton q4 = findViewById(R.id.q52d);
                switch (checkedId) {
                    case R.id.q52c:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg53.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q53a);
                RadioButton q2 = findViewById(R.id.q53b);
                RadioButton q3 = findViewById(R.id.q53c);
                RadioButton q4 = findViewById(R.id.q53d);
                switch (checkedId) {
                    case R.id.q53a:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg56.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                RadioButton q2 = findViewById(R.id.q56b);
                RadioButton q3 = findViewById(R.id.q56c);
                RadioButton q1 = findViewById(R.id.q56d);
                switch (checkedId) {
                    case R.id.q56d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg57.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q3 = findViewById(R.id.q57a);
                RadioButton q1 = findViewById(R.id.q57b);
                RadioButton q2 = findViewById(R.id.q57c);
        ...
        rg58.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                RadioButton q1 = findViewById(R.id.q58c);
                RadioButton q3 = findViewById(R.id.q58d);
                switch (checkedId) {
                    case R.id.q58c:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg59.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q2 = findViewById(R.id.q59a);
                RadioButton q1 = findViewById(R.id.q59b);
                RadioButton q3 = findViewById(R.id.q59c);
        ...
        rg60.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q3 = findViewById(R.id.q60a);
                RadioButton q2 = findViewById(R.id.q60b);
                RadioButton q1 = findViewById(R.id.q60c);
        ...
        rg61.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q61a);
                RadioButton q2 = findViewById(R.id.q61b);
                RadioButton q3 = findViewById(R.id.q61c);
        ...
        rg63.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q3 = findViewById(R.id.q63a);
                RadioButton q2 = findViewById(R.id.q63b);
                RadioButton q1 = findViewById(R.id.q63c);
        ...
        rg64.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q64a);
                RadioButton q2 = findViewById(R.id.q64b);
                RadioButton q3 = findViewById(R.id.q64c);
                RadioButton q4 = findViewById(R.id.q64d);
                switch (checkedId) {
                    case R.id.q64a:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg65.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                RadioButton q4 = findViewById(R.id.q65b);
                RadioButton q3 = findViewById(R.id.q65c);
                RadioButton q1 = findViewById(R.id.q65d);
                switch (checkedId) {
                    case R.id.q65d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg66.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q4 = findViewById(R.id.q66a);
                RadioButton q2 = findViewById(R.id.q66b);
                RadioButton q3 = findViewById(R.id.q66c);
                RadioButton q1 = findViewById(R.id.q66d);
                switch (checkedId) {
                    case R.id.q66d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg67.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q67a);
                RadioButton q2 = findViewById(R.id.q67b);
                RadioButton q3 = findViewById(R.id.q67c);
                RadioButton q4 = findViewById(R.id.q67d);
                switch (checkedId) {
                    case R.id.q67a:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg68.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q2 = findViewById(R.id.q68a);
                RadioButton q1 = findViewById(R.id.q68b);
                RadioButton q3 = findViewById(R.id.q68c);
                RadioButton q4 = findViewById(R.id.q68d);
                switch (checkedId) {
                    case R.id.q68b:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg69.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q2 = findViewById(R.id.q69a);
                RadioButton q4 = findViewById(R.id.q69b);
                RadioButton q3 = findViewById(R.id.q69c);
                RadioButton q1 = findViewById(R.id.q69d);
                switch (checkedId) {
                    case R.id.q69d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg70.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                RadioButton q1 = findViewById(R.id.q70b);
                RadioButton q3 = findViewById(R.id.q70c);
                RadioButton q4 = findViewById(R.id.q70d);
                switch (checkedId) {
                    case R.id.q70b:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg71.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q71a);
                RadioButton q2 = findViewById(R.id.q71b);
                RadioButton q3 = findViewById(R.id.q71c);
                RadioButton q4 = findViewById(R.id.q71d);
                switch (checkedId) {
                    case R.id.q71a:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg72.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                RadioButton q4 = findViewById(R.id.q72b);
                RadioButton q3 = findViewById(R.id.q72c);
                RadioButton q1 = findViewById(R.id.q72d);
                switch (checkedId) {
                    case R.id.q72d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg73.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q73a);
                RadioButton q2 = findViewById(R.id.q73b);
        ...
        rg75.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q2 = findViewById(R.id.q75a);
                RadioButton q3 = findViewById(R.id.q75b);
                RadioButton q1 = findViewById(R.id.q75c);
        ...
        rg76.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q3 = findViewById(R.id.q76a);
                RadioButton q2 = findViewById(R.id.q76b);
                RadioButton q1 = findViewById(R.id.q76c);
                RadioButton q4 = findViewById(R.id.q76d);
                switch (checkedId) {
                    case R.id.q76c:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg77.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q3 = findViewById(R.id.q77a);
                RadioButton q2 = findViewById(R.id.q77b);
                RadioButton q4 = findViewById(R.id.q77c);
                RadioButton q1 = findViewById(R.id.q77d);
                switch (checkedId) {
                    case R.id.q77d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg78.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q3 = findViewById(R.id.q78a);
                RadioButton q2 = findViewById(R.id.q78b);
                RadioButton q1 = findViewById(R.id.q78c);
                RadioButton q4 = findViewById(R.id.q78d);
                switch (checkedId) {
                    case R.id.q78c:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg79.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q4 = findViewById(R.id.q79a);
                RadioButton q1 = findViewById(R.id.q79b);
                RadioButton q2 = findViewById(R.id.q79c);
                RadioButton q3 = findViewById(R.id.q79d);
                switch (checkedId) {
                    case R.id.q79b:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg80.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q4 = findViewById(R.id.q80a);
                RadioButton q2 = findViewById(R.id.q80b);
                RadioButton q3 = findViewById(R.id.q80c);
                RadioButton q1 = findViewById(R.id.q80d);
                switch (checkedId) {
                    case R.id.q80d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg81.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q81a);
                RadioButton q2 = findViewById(R.id.q81b);
                RadioButton q3 = findViewById(R.id.q81c);
                RadioButton q4 = findViewById(R.id.q81d);
                switch (checkedId) {
                    case R.id.q81a:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg82.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q3 = findViewById(R.id.q82a);
                RadioButton q1 = findViewById(R.id.q82b);
                RadioButton q2 = findViewById(R.id.q82c);
                RadioButton q4 = findViewById(R.id.q82d);
                switch (checkedId) {
                    case R.id.q82b:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg83.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q4 = findViewById(R.id.q83a);
                RadioButton q2 = findViewById(R.id.q83b);
                RadioButton q3 = findViewById(R.id.q83c);
                RadioButton q1 = findViewById(R.id.q83d);
                switch (checkedId) {
                    case R.id.q83d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg84.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q84a);
                RadioButton q2 = findViewById(R.id.q84b);
                RadioButton q3 = findViewById(R.id.q84c);
                RadioButton q4 = findViewById(R.id.q84d);
                switch (checkedId) {
                    case R.id.q84a:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg85.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q3 = findViewById(R.id.q85a);
                RadioButton q2 = findViewById(R.id.q85b);
                RadioButton q1 = findViewById(R.id.q85c);
                RadioButton q4 = findViewById(R.id.q85d);
                switch (checkedId) {
                    case R.id.q85c:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg86.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q3 = findViewById(R.id.q86a);
                RadioButton q2 = findViewById(R.id.q86b);
                RadioButton q1 = findViewById(R.id.q86c);
                RadioButton q4 = findViewById(R.id.q86d);
                switch (checkedId) {
                    case R.id.q86c:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg87.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q2 = findViewById(R.id.q87a);
                RadioButton q1 = findViewById(R.id.q87b);
                RadioButton q3 = findViewById(R.id.q87c);
                RadioButton q4 = findViewById(R.id.q87d);
                switch (checkedId) {
                    case R.id.q87b:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg88.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q3 = findViewById(R.id.q88a);
                RadioButton q2 = findViewById(R.id.q88b);
                RadioButton q4 = findViewById(R.id.q88c);
                RadioButton q1 = findViewById(R.id.q88d);
                switch (checkedId) {
                    case R.id.q88d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg89.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q3 = findViewById(R.id.q89a);
                RadioButton q2 = findViewById(R.id.q89b);
                RadioButton q1 = findViewById(R.id.q89c);
                RadioButton q4 = findViewById(R.id.q89d);
                switch (checkedId) {
                    case R.id.q89c:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg90.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q90a);
                RadioButton q4 = findViewById(R.id.q90b);
                RadioButton q3 = findViewById(R.id.q90c);
                RadioButton q2 = findViewById(R.id.q90d);
                switch (checkedId) {
                    case R.id.q90a:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg91.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q4 = findViewById(R.id.q91a);
                RadioButton q1 = findViewById(R.id.q91b);
                RadioButton q3 = findViewById(R.id.q91c);
                RadioButton q2 = findViewById(R.id.q91d);
                switch (checkedId) {
                    case R.id.q91b:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg92.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q92a);
                RadioButton q2 = findViewById(R.id.q92b);
                RadioButton q3 = findViewById(R.id.q92c);
                RadioButton q4 = findViewById(R.id.q92d);
                switch (checkedId) {
                    case R.id.q92a:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg93.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q2 = findViewById(R.id.q93a);
                RadioButton q4 = findViewById(R.id.q93b);
                RadioButton q3 = findViewById(R.id.q93c);
                RadioButton q1 = findViewById(R.id.q93d);
                switch (checkedId) {
                    case R.id.q93d:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg94.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q1 = findViewById(R.id.q94a);
                RadioButton q4 = findViewById(R.id.q94b);
                RadioButton q3 = findViewById(R.id.q94c);
                RadioButton q2 = findViewById(R.id.q94d);
                switch (checkedId) {
                    case R.id.q94a:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg95.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q2 = findViewById(R.id.q95a);
                RadioButton q1 = findViewById(R.id.q95b);
                RadioButton q3 = findViewById(R.id.q95c);
                RadioButton q4 = findViewById(R.id.q95d);
                switch (checkedId) {
                    case R.id.q95b:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg96.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q2 = findViewById(R.id.q96a);
                RadioButton q1 = findViewById(R.id.q96b);
                RadioButton q3 = findViewById(R.id.q96c);
                RadioButton q4 = findViewById(R.id.q96d);
                switch (checkedId) {
                    case R.id.q96b:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg97.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q2 = findViewById(R.id.q97a);
                RadioButton q1 = findViewById(R.id.q97b);
                RadioButton q3 = findViewById(R.id.q97c);
                RadioButton q4 = findViewById(R.id.q97d);
                switch (checkedId) {
                    case R.id.q97b:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg98.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q2 = findViewById(R.id.q98a);
                RadioButton q1 = findViewById(R.id.q98b);
                RadioButton q3 = findViewById(R.id.q98c);
                RadioButton q4 = findViewById(R.id.q98d);
                switch (checkedId) {
                    case R.id.q98b:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg99.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q3 = findViewById(R.id.q99a);
                RadioButton q1 = findViewById(R.id.q99b);
                RadioButton q2 = findViewById(R.id.q99c);
                RadioButton q4 = findViewById(R.id.q99d);
                switch (checkedId) {
                    case R.id.q99b:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
        ...
        rg100.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton q2 = findViewById(R.id.q100a);
                RadioButton q1 = findViewById(R.id.q100b);
                RadioButton q3 = findViewById(R.id.q100c);
                RadioButton q4 = findViewById(R.id.q100d);
                switch (checkedId) {
                    case R.id.q100b:
                        q1.setBackgroundColor(Color.parseColor("#00ff00"));
                        q2.setEnabled(false);
